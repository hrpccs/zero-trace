...
**详细性能报告文档在** [性能测试文档](./performance_test)
...
这也导致了相比于单独的内核 IO 请求追踪，guest 和 host 协同对 virtblk 进行追踪的性能开销会很高。性能分析见[性能测试文档](./performance_test)
...
简单的功能展示如下（具体可以到查看 [功能测试文档](./doc/functional_test.md)
