...
run_process = subprocess.Popen(['sysbench', '--threads=8', '--report-interval=4', '--time=60', '--test=fileio', '--file-num=4', '--file-total-size=1G', '--file-test-mode=rndrw', 'run'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
