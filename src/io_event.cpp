...
bool IORequest::isRelative(int pid,
                           int tid,
...
bool IORequest::isEqual(unsigned long long inode,
                        unsigned long long offset,
                        unsigned long nr_bytes) {
    if (this->inode != inode) {
        return false;
...
// void print() override {}
void BlockPendingDuration::printfmtNtap(FILE* file,
                                        int tapnum,
...
void BioObject::addAssociation(unsigned long long inode,
                               unsigned long offset,
                               unsigned long nr_bytes) {
    associations.push_back(Association(inode, offset, nr_bytes));
}

void BioObject::isRelative(unsigned long long inode,
                           unsigned long long offset,
                           unsigned long nr_bytes,
                           std::vector<int>& index) {
