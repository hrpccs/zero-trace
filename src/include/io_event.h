...
class BioObject : public AsyncObject {
  public:
    ...
    struct Association { // use to find
        Association(unsigned long long inode,
    ...
    void addAssociation(unsigned long long inode,
                        unsigned long offset,
                        unsigned long nr_bytes);

    void isRelative(unsigned long long inode,
                    unsigned long long offset,
                    unsigned long nr_bytes,
...
class IORequest : public Request {
  public:
    ...
    bool isRelative(int pid,
                    int tid,
                    unsigned long long inode,
                    unsigned long long offset,
                    unsigned long nr_bytes);

    bool isEqual(unsigned long long inode,
                 unsigned long long offset,
                 unsigned long nr_bytes);
